...
// DELETE - perform DELETE request on http://localhost:3000/api/v1/portfolio/:id - STEP 1 Done | STEP 2 - perform actual queries
// UPDATE - perform PUT request on http://localhost:3000/api/v1/portfolio/:id - STEP 1 Done | STEP 2 - perform actual queries
// CREATE - - perform POST request on http://localhost:3000/api/v1/portfolio - STEP 1 Done | STEP 2 - perform actual queries

// NON-REST - CUSTOM
// GET /api/v1/stocks/portfolio?symbol=AAPL
// GET /api/v1/stocks/portfolio/AAPL
// GET /api/v1/stocks/portfolio/MSFT
// POST /api/v1/stocks/portfolio req.body
